// @ts-nocheck
// HYBE 결과 단계 래퍼 — useHybeAudition 훅으로 3명 병렬 평가 → 토론 → 최종 결과
      ...
      >
        <div style={{ textAlign: 'center', maxWidth: 520 }}>
          ...
          <p style={{ margin: 0, fontSize: 13, color: 'rgba(255,255,255,0.6)' }}>
            이준혁(데이터) · 김소연(직관) · David Lim(글로벌)이 동시에 평가하고 있습니다.
          </p>
        </div>

        <div style={{ width: '100%', maxWidth: 720 }}>
          <HybeDebateScreen debate={audition.debateResult} loading={true} />
        </div>
