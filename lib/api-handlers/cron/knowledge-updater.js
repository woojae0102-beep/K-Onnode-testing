...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).json({ success: true, message: '지식 베이스 업데이트 완료', totalSources: results.length, deletedOld, userPatterns, stats: knowledgeStats });
  } catch (err) {
